...
if not exist "%~dp0X17-59186.iso" echo please put X17-59186.iso side by side with this batch file
if not exist "%~dp0X17-59186.iso" start "iexplore" "https://drive.google.com/uc?export=download&id=0BxJgS33zZl9bZF9LWXJhakZaVGs"
if not exist "%~dp0X17-59186.iso" goto exit
...
echo extracting iso
"%~dp07z.exe" x "%~dp0X17-59186.iso" -o"%w%\iso" > nul 2>&1
echo.
...
echo.
echo Creating win7ie11x64professional.iso
"C:\Program Files (x86)\Windows Kits\10\Assessment and Deployment Kit\Deployment Tools\amd64\Oscdimg\oscdimg.exe" -b"%w%\iso\boot\etfsboot.com" -h -u2 -m -l"Win7ie11x64" "%w%\iso" "%~dp0win7ie11x64professional.iso"  > nul 2>&1
echo.
